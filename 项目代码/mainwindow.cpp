...
void MainWindow::initStatusBar()
{
    ...
    statusLabel1->setText(tr("copyright@TianranZhang"));
    statusLabel2->setText(tr("0000-00-00 00:00::00 星期 "));
    statusLabel3->setText(tr("欢迎使用上海地铁换乘系统"));
}
...
{
    statusLabel3->setText(tr("上海地铁网络线路图"));
    scene->clear();
    QList<int> stationsList;
    QList<Edge> edgesList;
...
void MainWindow::on_actionAuthor_triggered()
{
    ...
    box.setIcon(QMessageBox::Information);
    box.setText(tr("Author : Tianran Zhang \n"
